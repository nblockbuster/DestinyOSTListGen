...
namespace Tiger.Formats
{
    ...
    public class Entry
    {
        ...
        public UInt32 entry_index { get; set; }
        ...
        public Entry(UInt32 entry_a, UInt32 entry_b, UInt32 entry_c, UInt32 entry_d, UInt32 entry_index)
        {
